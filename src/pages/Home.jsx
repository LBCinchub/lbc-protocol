...
const domains = [
  ...
  { url: 'lbchub.io',             fullUrl: 'https://lbchub.io',             name: 'Big Brother — LBC Protocol',        description: 'Central intelligence and ecosystem coordination',                 icon: LayoutDashboard, gradient: 'from-indigo-600 to-purple-500',   glow: 'rgba(102,51,153,0.15)' },
