...
const domains = [
  ...
  { url: 'LBC.com',               fullUrl: 'https://lumina-blockchain.com', name: 'LBC Wallet',                  description: 'LBC Wallet — non-custodial LBC wallet for $LBC, SOL & USDC with full documentation', icon: Wallet,          gradient: 'from-amber-400 to-yellow-300',   glow: 'rgba(251,191,36,0.15)' },
  ...
  { url: 'LBCHub.live',           fullUrl: 'https://lbchub.live',           name: 'LBC Live',                   description: 'LBC Live — the creator economy layer. Stream, earn fan tokens, and host live events powered by $LBC', icon: Radio,           gradient: 'from-red-600 to-orange-500',     glow: 'rgba(220,38,38,0.15)' },
