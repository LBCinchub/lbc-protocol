...
const domains = [
  ...
  { url: 'lbc-hub.com',           fullUrl: 'https://lbc-hub.com',           name: 'LBC Hub — Twin Sister',      description: 'LBC Hub — Twin Sister to lbchub.io, interactive operational dashboard and community platform',    icon: LayoutDashboard, gradient: 'from-violet-500 to-purple-400',   glow: 'rgba(139,92,246,0.15)' },
  { url: 'lbchub.site',           fullUrl: 'https://lbchub.site',           name: 'LBC AI — Twin Sister',       description: 'LBC AI — Twin Sister AI builder platform, powered by Lumina Ultra intelligent automation',         icon: Building,        gradient: 'from-orange-500 to-amber-400',   glow: 'rgba(249,115,22,0.15)' },
