...
const domains = [
  ...
  { url: 'lbchub.site',           fullUrl: 'https://lbchub.site',           name: 'Lumina Ultra',       description: 'AI builder platform — Lumina Ultra, twin sister to Lumina AI, powered by intelligent automation',          icon: Building,        gradient: 'from-orange-500 to-amber-400',   glow: 'rgba(249,115,22,0.15)' },
