...
const domains = [
  ...
  { url: 'lumina-blockchain.com', fullUrl: 'https://lumina-blockchain.com', name: 'LBC Wallet',         description: 'Lumina Blockchain Wallet — $LBC token, blockchain wallet & documentation',                 icon: Wallet,          gradient: 'from-amber-400 to-yellow-300',   glow: 'rgba(251,191,36,0.15)' },
  { url: 'lbchub.ca',             fullUrl: 'https://lbchub.ca',             name: 'LBC Investor Relations', description: 'Investment opportunities, reports & financials',                 icon: TrendingUp,      gradient: 'from-indigo-500 to-blue-400',    glow: 'rgba(99,102,241,0.15)' },
  { url: 'lbchub.app',            fullUrl: 'https://lbchub.app',            name: 'LBC Driver Portal',  description: 'Driver management and logistics center',                        icon: Truck,           gradient: 'from-emerald-500 to-teal-400',   glow: 'rgba(16,185,129,0.15)' },
  ...
  { url: 'lbchub.shop',           fullUrl: 'https://lbchub.shop',           name: 'LBC Official Store', description: 'Merchandise, products and branded goods',                       icon: ShoppingBag,     gradient: 'from-fuchsia-500 to-purple-400', glow: 'rgba(217,70,239,0.15)' },
  ...
  { url: 'lbchub.art',            fullUrl: 'https://lbchub.art',            name: 'LBC NFT Gallery',    description: 'Digital art collection and NFT showcase',                       icon: Palette,         gradient: 'from-cyan-500 to-teal-400',      glow: 'rgba(6,182,212,0.15)' },
  { url: 'lbchub.org',            fullUrl: 'https://lbchub.org',            name: 'LBC Charity',        description: 'Community initiatives and social impact',                       icon: Heart,           gradient: 'from-rose-500 to-pink-400',      glow: 'rgba(244,63,94,0.15)' },
  { url: 'lbchub.live',           fullUrl: 'https://lbchub.live',           name: 'LBC War Zone Radar', description: 'Real-time radar and live intelligence from active war zones',   icon: Radio,           gradient: 'from-red-600 to-orange-500',     glow: 'rgba(220,38,38,0.15)' },
  { url: 'lbchub.support',        fullUrl: 'https://lbchub.support',        name: 'LBC Support Center',     description: 'Official LBC support — the only support channel we operate',     icon: HeadphonesIcon,  gradient: 'from-sky-500 to-blue-400',       glow: 'rgba(14,165,233,0.15)' },
];
