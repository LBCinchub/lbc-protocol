...
const domains = [
  ...
  { url: 'lbchub.site',           fullUrl: 'https://lbchub.site',           name: 'Lumina Ultra — Twin Sister',  description: 'Lumina Ultra — Twin Sister AI converse & builder platform powered by Luna intelligent automation',    icon: Building,        gradient: 'from-orange-500 to-amber-400',   glow: 'rgba(249,115,22,0.15)' },
